...
let UserToken = (_dec = (0, _typeorm.Entity)('users_token'), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)({
  type: 'nchar',
  length: 36
  ...
  type: 'datetime'
}), _dec11 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec12 = (0, _typeorm.CreateDateColumn)({
  type: 'datetime'
}), _dec13 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class UserToken {
  constructor() {
    ...
    _initializerDefineProperty(this, "expires_in", _descriptor4, this);
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "expires_in", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
