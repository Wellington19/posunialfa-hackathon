...
exports.User = void 0;
var _RatingImc = require("../../../../rating/infra/typeorm/entities/RatingImc");
...
let User = (_dec = (0, _typeorm.Entity)('users'), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)({
  type: 'nchar',
  length: 36
  ...
  type: 'datetime'
}), _dec17 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec18 = (0, _typeorm.ManyToOne)(() => _RatingImc.RatingImc, ratingImc => ratingImc.user_rating), _dec19 = (0, _typeorm.JoinColumn)({
  name: 'id',
  referencedColumnName: 'user_rating_id'
}), _dec20 = Reflect.metadata("design:type", typeof _RatingImc.RatingImc === "undefined" ? Object : _RatingImc.RatingImc), _dec21 = (0, _typeorm.ManyToOne)(() => _RatingImc.RatingImc, ratingImc => ratingImc.user_student), _dec22 = (0, _typeorm.JoinColumn)({
  name: 'id',
  referencedColumnName: 'user_student_id'
}), _dec23 = Reflect.metadata("design:type", typeof _RatingImc.RatingImc === "undefined" ? Object : _RatingImc.RatingImc), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class User {
  constructor() {
    ...
    _initializerDefineProperty(this, "situation", _descriptor6, this);
    _initializerDefineProperty(this, "created_at", _descriptor7, this);
    _initializerDefineProperty(this, "user_rating", _descriptor8, this);
    _initializerDefineProperty(this, "user_student", _descriptor9, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "profile", [_dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "situation", [_dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "user_rating", [_dec18, _dec19, _dec20], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "user_student", [_dec21, _dec22, _dec23], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
